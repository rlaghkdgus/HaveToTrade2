...
{   
    ...
    private void TextReset()
    {
        if (currentQuestType == QuestType.Trade)
            targetQuestText.text = "품목 :" + InGameUtills.RetStuffName(qTargetItem) + "\n" + "목적지 :" + HangeulVillage(questVillage) + "\n" + "  " + questTarget + " / " + questGoal + "  " + BuyOrSellText();
        else if (currentQuestType == QuestType.Delivery)
            targetQuestText.text = "품목 :" + InGameUtills.RetStuffName(qTargetItem) + " 목적지 :" + HangeulVillage(questVillage);
        else
            targetQuestText.text = "";
    }
    ...
    public string HangeulVillage(VillageType village)
    {
        switch(village)
        {
            case VillageType.GreStar: return "그레스타";
            case VillageType.GoldBen: return "골드벤";
            case VillageType.Smokian: return "스모키안";
            default: return "관계없음";    
        }
    }
