...
public class DialogData : ScriptableObject
{
	...
	public List<TextData> 유쾌한재흥정; // Replace 'EntityType' to an actual type that is serializable.
	public List<TextData> 아이템이름출력; // Replace 'EntityType' to an actual type that is serializable.
	public List<TextData> 유쾌한거래전인사; // Replace 'EntityType' to an actual type that is serializable.
	...
	public List<TextData> 상인구매흥정오류;
	public List<TextData> 상인판매흥정오류;
}
